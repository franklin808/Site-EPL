...
const slider = document.getElementById('product-slider');
  ...
  function renderSliderItems() {
    ...
    const fullItems = items.concat(items); // Loop infinito fake
...
<div class="p-4 flex-grow flex flex-col justify-between">
  ...
  <a href="produto.html?produto=${encodeURIComponent(item.title)}" class="mt-auto inline-block bg-purple-700 hover:bg-purple-800 text-white text-sm px-4 py-2 rounded-full text-center transition">
    Saiba mais
  </a>
</div>
  ...
  // ✅ Swipe com Hammer.js (funciona iOS e Android)
